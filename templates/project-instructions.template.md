...
orientar → resolver la brecha dominante → asignar Cycle Owner → planificar o ejecutar → devolver el artefacto al destino declarado → revisar e iterar → escalar solo cuando corresponda.
...
- No por falta de una decisión de dominio: continúa o deriva al espacio correcto.
